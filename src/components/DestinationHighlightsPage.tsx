...
export default function DestinationHighlightsPage({ lang, onNavigateHome }: DestinationHighlightsPageProps) {
  ...
  const handleWhatsAppBooking = (highlightTitle: string, categoryName: string) => {
    ...
    const message = `Halo Siaga Tour, saya ingin berkonsultasi mengenai paket tour: ${highlightTitle} (${categoryName}). Mohon informasi jadwal, fasilitas hotel/restoran & penawaran harga terbaik. Terima kasih!`;

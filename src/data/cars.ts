...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    text: 'Sangat puas menggunakan jasa PT. SIAGA WISATA JAYA (Siaga Tour)! Pelayanannya profesional sejak tahun 2010. Big Bus VIP nya amat nyaman, AC dingin, toilet bersih, bantal selimut lengkap. Bang Jaya dan tim Tour Leader sangat amanah memandu rombongan kami.',
    rating: 5,
  ...
  },
  {
    ...
    text: 'Kami langganan sewa Hiace Premio & Elf Jumbo dari Siaga Tour Pejaten Barat. Bang Jaya sangat ramah dan kooperatif. Perjalanan ke Jogja dan Dieng sangat amanah, hemat, dan pelayanan primanya beneran terbukti!',
    rating: 5,
